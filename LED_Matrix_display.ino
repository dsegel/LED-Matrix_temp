...
float getCurrentTemp() {
  ...
  // City example URL: http://api.wunderground.com/api/c4789291f0cceab2/conditions/q/CA/Davis.json
  //  PWS example URL: http://api.wunderground.com/api/c4789291f0cceab2/conditions/lang:EN/q/pws:KCADAVIS46.json
